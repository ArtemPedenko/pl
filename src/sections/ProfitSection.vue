    ...
    <div class="max-w-[1200px] w-full m-auto flex flex-col gap-[40px]">
      ...
      <div class="grid grid-cols-6 grid-rows-[192px_280px_144px] gap-5">
        <div class="col-span-3">
          <ProfitCard pad="pr-[120px]" imgPath="@/assets/images/profit1.png">
        ...
        <div class="col-span-3 col-start-4">
          <ProfitCard pad="pr-[120px]" imgPath="@/assets/images/profit2.png">
        ...
        <div class="col-span-2 row-start-2">
          <ProfitCard imgPath="@/assets/profit3.png">
        ...
        <div class="col-span-2 col-start-3 row-start-2">
          <ProfitCard imgPath="@/assets/profit4.png">
            <template #heading
        ...
        <div class="col-span-2 col-start-5 row-start-2">
          <ProfitCard imgPath="@/assets/profit5.png">
        ...
        <div class="col-span-6 row-start-3">
          <ProfitCard pad="pr-[120px]" imgPath="@/assets/profit6.png">
            <template #heading
